...
beq $zero, $a0, $a1, $imm1, BaseCase, 0      # check if n equals k, proceed to base case
beq $zero, $a1, $zero, $imm1, BaseCase, 0   # check if k equals 0, proceed to base case
beq $zero, $zero, $zero, $imm1, RecursiveCase, 0 # else proceed with recursive calculation
BaseCase:
add $v0, $imm1, $zero, $zero, 1, 0          # Set return value to 1 for base case
beq $zero, $zero, $zero, $imm2, 0, Cleanup  # move to cleanup and return
RecursiveCase:
sub $a0, $a0, $imm1, $zero, 1, 0           # get n - 1 for recursive call
jal $ra, $zero, $zero, $imm1, CalcBinom, 0 # recursive call for binom(n-1, k)
...
jal $ra, $zero, $zero, $imm1, CalcBinom, 0 # recursive call for binom(n-1, k-1)
